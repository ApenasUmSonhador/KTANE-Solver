...
public class Genius implements Module {
	...
	private int errors;
	// Constants to store the colors
	private static final String[][] colorVowel = { { "azul", "vermelho", "amarelo", "verde" },
			{ "amarelo", "verde", "azul", "vermelho" },
			{ "verde", "amarelo", "vermelho", "azul" } };
	private static final String[][] colorNoVowel = { { "azul", "amarelo", "verde", "vermelho" },
	...
	public void solve() {
		...
		pattern = hasVowel ? colorVowel[errors] : colorNoVowel[errors];
